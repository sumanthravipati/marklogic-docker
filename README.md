 ...
 * [TLS Enabled Cluster](#TLS-enabled-cluster)
...
1. Create a new docker secret for certificate using below command:

- Create certificate_v2.cer file and use the following command to add a new Docker secret:
```
  $docker secret create certificate_v2.cer certificate_v2.cer
```
6. Use the below command to rotate the Docker secret for the mlstack_node2 Docker services created above using Docker stack:
```
docker service update \
